...
from config import SUBJECTS, CONSCIOUS_CONDITIONS, UNCONSCIOUS_CONDITIONS


def main():
    parser = argparse.ArgumentParser(description='Train consciousness detection models')
    ...
    if args.save_results:
        ...
        for model_type, result in results.items():
            json_results[model_type] = {
                ...
                'per_subject_metrics': result['per_subject_metrics']
            }
